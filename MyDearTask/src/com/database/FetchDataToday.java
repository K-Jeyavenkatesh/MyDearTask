...
public class FetchDataToday {
	
	private ArrayList<ArrayList<String>> arr;
	
	public ArrayList<ArrayList<String>> FetchDataToday(String user) {
		...
		try {
			...
			while(result.next()) {
				if(result.getString(7).equals("Not Completed")) {
	...
	public int changeToday(String key) {
	...
	public int postponeToday(String key) {
	...
	public int cancelToday(String key) {
