...
public class FetchDataUpcoming {
	
	private ArrayList<ArrayList<String>> arr;
	
	public ArrayList<ArrayList<String>> FetchDataUpcoming(String user) {
		...
		try {
			...
			while(result.next()) {
				if(result.getString(7).equals("Upcoming")) {
	...
	public int changeUpcoming(String key) {
	...
	public int postponeUpcoming(String key) {
	...
	public int cancelUpcoming(String key) {
